...
function string_of_content(x) {
  if (typeof x === "number") {
    ...
    } else if (variant !== -245900134) {
      if (variant >= -856044370) {
        if (variant >= 5843823) {
...
function string_of_position(l) {
  if (typeof l === "number") {
    ...
    var variant = l[0];
    if (variant !== -245900134 && variant < 5889767) {
      return Css_AtomicTypes.Length.toString(l);
    } else {
...
function string_of_dasharray(p) {
  if (typeof p === "number" || p[0] !== -119887163) {
            ...
            typeof x === "number" ? (
                x >= 67859554 ? (
                    x >= 516682146 ? (
                        ...
                        x >= 116572373 ? Css_AtomicTypes.BaselineAlignment.toString(x) : Css_AtomicTypes.AlignContent.toString(x)
                      )
                  ) : (
                    x !== -1016061555 ? (
                        x >= -485895757 ? (
                            x !== -222697221 ? Css_AtomicTypes.DistributedAlignment.toString(x) : Css_AtomicTypes.BaselineAlignment.toString(x)
                          ) : (
                ...
                x >= 51834799 ? (
                    x !== 653193961 ? (
                        x >= 662439529 ? (
                            ...
                            x >= 116572373 ? Css_AtomicTypes.BaselineAlignment.toString(x) : Css_AtomicTypes.PositionalAlignment.toString(x)
                          )
                      ) : Css_AtomicTypes.Cascading.toString(x)
                  ) : (
                    x !== -379319332 ? (
                        x >= -222697221 ? (
                            x >= -162316795 ? Css_AtomicTypes.AlignItems.toString(x) : Css_AtomicTypes.BaselineAlignment.toString(x)
                          ) : (
  ...
  return /* D */Block.__(0, [
            ...
            typeof x === "number" ? (
                x >= 51834799 ? (
                    ...
                    x >= -878767996 ? (
                        x >= -222697221 ? (
                            x >= -162316795 ? Css_AtomicTypes.AlignSelf.toString(x) : Css_AtomicTypes.BaselineAlignment.toString(x)
                          ) : (
...
function clipPath(x) {
  return /* D */Block.__(0, [
            ...
            typeof x === "number" ? (
                ...
                x[0] !== 5843823 ? Css_AtomicTypes.Var.toString(x) : Css_AtomicTypes.Url.toString(x)
              )
          ]);
}
...
function columnCount(x) {
  return /* D */Block.__(0, [
            "columnCount",
            typeof x === "number" ? (
                x >= -878767996 ? Css_AtomicTypes.Cascading.toString(x) : Css_AtomicTypes.ColumnCount.toString(x)
              ) : (
                x[0] >= -245900134 ? Css_AtomicTypes.Var.toString(x) : Css_AtomicTypes.ColumnCount.toString(x)
              )
          ]);
}
...
function fontFamily(x) {
  return /* D */Block.__(0, [
            "fontFamily",
            typeof x === "number" ? (
                x !== -878767996 && x !== -601204732 && x < 653193961 ? Css_AtomicTypes.FontFamilyName.toString(x) : Css_AtomicTypes.Cascading.toString(x)
              ) : (
                x[0] >= 1066567601 ? Css_AtomicTypes.FontFamilyName.toString(x) : Css_AtomicTypes.Var.toString(x)
              )
          ]);
}
...
function fontSize(x) {
  var tmp;
  if (typeof x === "number") {
    tmp = x !== -789508312 ? Css_AtomicTypes.Cascading.toString(x) : Css_AtomicTypes.Length.toString(x);
  } else {
    var variant = x[0];
    tmp = variant !== -245900134 && variant < 5889767 ? Css_AtomicTypes.Length.toString(x) : Css_AtomicTypes.Var.toString(x);
  }
  return /* D */Block.__(0, [
            "fontSize",
            tmp
...
function fontWeight(x) {
  return /* D */Block.__(0, [
            "fontWeight",
            typeof x === "number" ? (
                x !== -878767996 && x !== -601204732 && x !== 653193961 ? Css_AtomicTypes.FontWeight.toString(x) : Css_AtomicTypes.Cascading.toString(x)
              ) : (
                x[0] !== 5496390 ? Css_AtomicTypes.Var.toString(x) : Css_AtomicTypes.FontWeight.toString(x)
              )
          ]);
}
...
function gridGap(x) {
  ...
  if (typeof x === "number") {
    ...
    var variant = x[0];
    tmp = variant !== -245900134 ? (
        variant !== -119887163 ? (
            variant >= 5889767 ? Css_AtomicTypes.Var.toString(x) : Css_AtomicTypes.Length.toString(x)
          ) : Css_AtomicTypes.Percentage.toString(x)
      ) : Css_AtomicTypes.Var.toString(x);
  }
  return /* D */Block.__(0, [
            "gridGap",
  ...
  return /* D */Block.__(0, [
            ...
            typeof x === "number" ? (
                x >= 287825029 ? (
                    x >= 812216871 ? (
                        x !== 956438739 ? (
                            x >= 812216872 ? Css_AtomicTypes.PositionalAlignment.toString(x) : Css_AtomicTypes.NormalAlignment.toString(x)
                          ) : Css_AtomicTypes.LegacyAlignment.toString(x)
                      ) : (
                        x >= 653193961 ? (
                            x >= 662439529 ? Css_AtomicTypes.PositionalAlignment.toString(x) : Css_AtomicTypes.Cascading.toString(x)
                          ) : (
                            x >= 442661449 ? Css_AtomicTypes.LegacyAlignment.toString(x) : Css_AtomicTypes.BaselineAlignment.toString(x)
                          )
                      )
                  ) : (
                    x >= -222697221 ? (
                        x >= 116572373 ? (
                            x >= 284231408 ? Css_AtomicTypes.LegacyAlignment.toString(x) : Css_AtomicTypes.BaselineAlignment.toString(x)
                          ) : (
                            x >= 51834799 ? Css_AtomicTypes.PositionalAlignment.toString(x) : Css_AtomicTypes.BaselineAlignment.toString(x)
                          )
                      ) : (
                        x >= -527929090 ? (
                            x >= -379319332 ? Css_AtomicTypes.PositionalAlignment.toString(x) : Css_AtomicTypes.LegacyAlignment.toString(x)
                          ) : (
                            x >= -878767996 ? Css_AtomicTypes.Cascading.toString(x) : Css_AtomicTypes.PositionalAlignment.toString(x)
                          )
                      )
                ...
                x[0] >= -245900134 ? Css_AtomicTypes.Var.toString(x) : Css_AtomicTypes.OverflowAlignment.toString(x)
              )
          ]);
}
...
function lineHeight(x) {
  ...
  if (typeof x === "number") {
    ...
    tmp = variant !== -245900134 ? (
        variant !== 4845682 ? (
            variant >= 5889767 ? Css_AtomicTypes.Var.toString(x) : Css_AtomicTypes.Length.toString(x)
          ) : Css_AtomicTypes.LineHeight.toString(x)
      ) : Css_AtomicTypes.Var.toString(x);
  }
  return /* D */Block.__(0, [
            "lineHeight",
...
function outline(size, style, color) {
  return /* D */Block.__(0, [
            "outline",
            Css_AtomicTypes.Length.toString(size) + (" " + (Css_AtomicTypes.OutlineStyle.toString(style) + (" " + string_of_color(color))))
          ]);
}
  ...
  return /* D */Block.__(0, [
            ...
            typeof x === "number" ? (
                x >= 51834799 ? (
                    ...
                    x >= -878767996 ? (
                        x >= -222697221 ? (
                            x >= -162316795 ? Css_AtomicTypes.JustifySelf.toString(x) : Css_AtomicTypes.BaselineAlignment.toString(x)
                          ) : (
                            x >= -379319332 ? Css_AtomicTypes.PositionalAlignment.toString(x) : Css_AtomicTypes.Cascading.toString(x)
                          )
                      ) : (
...
function textDecorationColor(x) {
  var tmp;
  if (typeof x === "number") {
    tmp = x >= 292050538 && x < 653193961 ? Css_AtomicTypes.Color.toString(x) : Css_AtomicTypes.Cascading.toString(x);
  } else {
    var variant = x[0];
    tmp = variant !== -245900134 && variant < 5889767 ? Css_AtomicTypes.Color.toString(x) : Css_AtomicTypes.Var.toString(x);
  }
  return /* D */Block.__(0, [
            "textDecorationColor",
            tmp
...
function textOverflow(x) {
  return /* D */Block.__(0, [
            "textOverflow",
            typeof x === "number" ? (
                x !== 166888785 && x >= -1044222255 ? Css_AtomicTypes.Cascading.toString(x) : Css_AtomicTypes.TextOverflow.toString(x)
              ) : (
                x[0] >= 288368849 ? Css_AtomicTypes.TextOverflow.toString(x) : Css_AtomicTypes.Var.toString(x)
              )
          ]);
}
...
function transform(x) {
  return /* D */Block.__(0, [
            "transform",
            typeof x === "number" ? "none" : Css_AtomicTypes.Transform.toString(x)
          ]);
}
...
function gridArea(s) {
  var tmp;
  if (typeof s === "number") {
    tmp = s >= -878767996 ? Css_AtomicTypes.Cascading.toString(s) : Css_AtomicTypes.GridArea.toString(s);
  } else {
    var variant = s[0];
    tmp = variant !== -245900134 && variant !== 5889767 ? Css_AtomicTypes.GridArea.toString(s) : Css_AtomicTypes.Var.toString(s);
  }
  return /* D */Block.__(0, [
            "gridArea",
            tmp
...
function gridTemplateAreas(l) {
  return /* D */Block.__(0, [
            "gridTemplateAreas",
            typeof l === "number" ? (
                l >= -878767996 ? Css_AtomicTypes.Cascading.toString(l) : Css_AtomicTypes.GridTemplateAreas.toString(l)
              ) : (
                l[0] >= 629510214 ? Css_AtomicTypes.GridTemplateAreas.toString(l) : Css_AtomicTypes.Var.toString(l)
              )
          ]);
}
...
function string_of_filter(u) {
  if (typeof u === "number") {
    ...
    if (variant >= -97740042) {
      if (variant >= 5889767) {
        if (variant >= 934407426) {
          if (variant >= 1036870963) {
            return "hue-rotate(" + (Css_AtomicTypes.Angle.toString(u[1]) + ")");
          } else {
            return "contrast(" + (u[1].toString() + "%)");
          }
        } else if (variant >= 534308630) {
          return "invert(" + (u[1].toString() + "%)");
        } else {
        ...
        if (variant >= 5843823) {
          ...
          return "sepia(" + (u[1].toString() + "%)");
        }
      } else {
        return "saturate(" + (u[1].toString() + "%)");
      }
    } else if (variant >= -445542959) {
      if (variant >= -245900134) {
        if (variant >= -214464569) {
          return "grayscale(" + (u[1].toString() + "%)");
        } else {
          return Css_AtomicTypes.Var.toString(u);
        }
      } else if (variant >= -345678389) {
        return "opacity(" + (u[1].toString() + "%)");
      } else {
        return "brightness(" + (u[1].toString() + "%)");
      }
      ...
      return "blur(" + (Css_AtomicTypes.Length.toString(u[1]) + ")");
    }
  }
}
...
function box($staropt$star, $staropt$star$1, $staropt$star$2, $staropt$star$3, $staropt$star$4, color) {
  ...
  return /* `shadow */[
          488687584,
          Css_AtomicTypes.Length.toString(x) + (" " + (Css_AtomicTypes.Length.toString(y) + (" " + (Css_AtomicTypes.Length.toString(blur) + (" " + (Css_AtomicTypes.Length.toString(spread) + (" " + (string_of_color(color) + (
                            inset ? " inset" : ""
                          )))))))))
        ];
}
...
function text($staropt$star, $staropt$star$1, $staropt$star$2, color) {
  ...
  return /* `shadow */[
          488687584,
          Css_AtomicTypes.Length.toString(x) + (" " + (Css_AtomicTypes.Length.toString(y) + (" " + (Css_AtomicTypes.Length.toString(blur) + (" " + string_of_color(color))))))
        ];
}
...
function boxShadow(x) {
  return /* D */Block.__(0, [
            "boxShadow",
            typeof x === "number" ? (
                x >= -878767996 ? Css_AtomicTypes.Cascading.toString(x) : toString$1(x)
              ) : (
                x[0] >= 488687584 ? toString$1(x) : Css_AtomicTypes.Var.toString(x)
              )
          ]);
}
...
function border(px, style, color) {
  return /* D */Block.__(0, [
            "border",
            Css_AtomicTypes.Length.toString(px) + (" " + (string_of_borderstyle(style) + (" " + string_of_color(color))))
          ]);
}
...
function background(x) {
  var tmp;
  if (typeof x === "number") {
    tmp = x >= 292050538 ? Css_AtomicTypes.Color.toString(x) : "none";
  } else {
    var variant = x[0];
    tmp = variant !== 5843823 ? (
        variant >= 5194459 ? (
            variant >= 119548911 ? Css_AtomicTypes.Gradient.toString(x) : Css_AtomicTypes.Color.toString(x)
          ) : (
            variant >= -657111370 ? Css_AtomicTypes.Gradient.toString(x) : Css_AtomicTypes.Color.toString(x)
          )
...
function backgrounds(x) {
  return /* D */Block.__(0, [
            "background",
            join(Belt_List.map(x, (function (item) {
...
function fontFace(fontFamily, src, fontStyle, fontWeight, fontDisplay, param) {
  ...
  var fontWeight$1 = Belt_Option.mapWithDefault(fontWeight, "", (function (w) {
          return "font-weight: " + ((
                    typeof w === "number" ? (
                        w !== -878767996 && w !== -601204732 && w !== 653193961 ? Css_AtomicTypes.FontWeight.toString(w) : Css_AtomicTypes.Cascading.toString(w)
                      ) : (
                        w[0] !== 5496390 ? Css_AtomicTypes.Var.toString(w) : Css_AtomicTypes.FontWeight.toString(w)
                      )
                  ) + ";");
        }));
...
function fill(x) {
  var tmp;
  if (typeof x === "number") {
    tmp = x !== 292050538 && x !== 582626130 ? Curry._1(Css_AtomicTypes.SVG.Fill.toString, x) : Css_AtomicTypes.Color.toString(x);
  } else {
    var variant = x[0];
    tmp = variant >= 5843823 ? (
        variant >= 5889767 ? Css_AtomicTypes.Var.toString(x) : Css_AtomicTypes.Url.toString(x)
      ) : (
        variant !== -245900134 ? Css_AtomicTypes.Color.toString(x) : Css_AtomicTypes.Var.toString(x)
      );
  }
  return /* D */Block.__(0, [
            "fill",
...
function strokeDasharray(x) {
  return /* D */Block.__(0, [
            "strokeDasharray",
            typeof x === "number" ? "none" : join(Belt_List.map(x[1], string_of_dasharray), " ")
          ]);
}
